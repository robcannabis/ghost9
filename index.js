...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1219074130704339044/1227467755024810025/yyavaax.gif?ex=6628836e&is=66160e6e&hm=cd958791bc4a86144486e1d9f9639a35c80548ace8987b73dd2ecf302e06f3bd&']; //รูปใหญ่
    ...
    const ddds = ['https://www.instagram.com/ghost92412?igsh=MTYxNWNtMXduOWhudg==']; // ลิ้ง button1

   const iooi = ['X']; // ชื่อ button 2
   const iiio = ['https://x.com/n_wpha?t=LNAGaj2UwIj0mQ6d5HoRXA&s=09']; // ลิ้ง button 2
